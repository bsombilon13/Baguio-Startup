              ...
              <div className="space-y-2 flex-1">
                <div className="flex items-center gap-3">
                   <span className={`
                     ...
                     ${opp.type === 'Incubation' ? 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400' : ''}
                     ${opp.type === 'Awards' ? 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400' : ''}
                     ${opp.type === 'Call for Experts' ? 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400' : ''}
                   `}>
                     {opp.type}
                   </span>
