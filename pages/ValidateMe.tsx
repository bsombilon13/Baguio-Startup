      ...
      <style>{`
        @media print {
          ...
          * { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
          /* Ensure scrollable areas expand in print */
        ...
        <div className="animate-in zoom-in-95 duration-500">
          <div className="flex justify-between items-center mb-6 no-print">
            ...
            <div className="flex gap-2">
                <button 
                onClick={handlePrint}
                className="flex items-center gap-2 text-slate-600 hover:text-[#35308f] dark:text-slate-300 dark:hover:text-white font-bold text-sm transition-colors bg-slate-100 dark:bg-slate-800 px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm"
                >
                <Printer size={16} /> Print
                </button>
                <button 
                onClick={() => { setReport(null); setIdea(''); }}
                className="flex items-center gap-2 text-slate-500 hover:text-[#35308f] dark:hover:text-white font-bold text-sm transition-colors bg-white dark:bg-slate-800 px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm"
                >
          ...
          <BentoGrid>
            ...
            <div className="md:col-span-1 flex flex-col gap-6">
                {/* Rarity Score */}
                <BentoItem className={`bg-gradient-to-br ${getScoreColor(report.rarityScore)} text-white flex flex-col justify-center items-center text-center !p-6 shadow-xl relative overflow-hidden flex-1 min-h-[200px]`}>
                ...
                {/* Idea Type Card */}
                <BentoItem className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 !p-6 flex flex-col justify-center min-h-[160px]">
            ...
            <BentoItem className="md:col-span-3 bg-white dark:bg-slate-900 !p-6 md:!p-8 flex flex-col justify-between">
              <div>
            ...
            <div className="col-span-1 md:col-span-4 rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-sm bg-white dark:bg-slate-900">
            ...
            <BentoItem className="md:col-span-1 bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-800 !p-6 md:!p-8">
            ...
            <BentoItem className="md:col-span-1 bg-rose-50 dark:bg-rose-900/10 border border-rose-100 dark:border-rose-800 !p-6 md:!p-8">
             ...
             <BentoItem className="md:col-span-2 bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-800 !p-6 md:!p-8">
            ...
            {/* Competitors */}
            <BentoItem className="md:col-span-2 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 !p-6 md:!p-8">
               ...
               <div className="space-y-3">
                  {report.competitors.map((comp, idx) => (
                    <a 
                      ...
                      className="flex items-center justify-between p-3 rounded-xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 hover:border-indigo-300 dark:hover:border-indigo-500 hover:shadow-md transition-all group"
                    >
            ...
            <BentoItem className="md:col-span-2 bg-slate-900 text-white dark:bg-white dark:text-slate-900 !p-8 md:!p-10 flex flex-col justify-center">
