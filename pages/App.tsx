      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 auto-rows-min">
        ...
        <div className="md:col-span-1 bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 p-6 flex flex-col items-center justify-center text-center shadow-sm min-h-[320px] h-full relative overflow-hidden group">
           ...
           <a 
             ...
             className="w-full py-3 bg-[#35308f] hover:bg-[#2a2670] text-white rounded-xl font-bold text-sm transition-all shadow-lg shadow-indigo-200 dark:shadow-none flex items-center justify-center gap-2 group-hover:shadow-xl mt-auto"
           >
        ...
        <div className="md:col-span-2 bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 p-6 flex flex-col justify-between gap-4 shadow-sm min-h-[320px] h-full">
           <div>
